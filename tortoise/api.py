...
class TextToSpeech:
    ...
    def __init__(self, autoregressive_batch_size=None, models_dir=MODELS_DIR, 
        ...
        if os.path.exists(f'{models_dir}/autoregressive.ptt'):
            ...
            ar_path=hf_hub_download(repo_id="NiftyBooks/Tortoise_TTS_German",filename="checkpoint_final_eng-1500.pth", cache_dir=models_dir)
    ...
    def tts(self, text, voice_samples=None, conditioning_latents=None, k=1, verbose=True, use_deterministic_seed=None,
            ...
            num_autoregressive_samples=512, temperature=.8, length_penalty=1, repetition_penalty=2.5, top_p=.8, max_mel_tokens=500,
